...
#data_raw<-read.csv(file="allruns_retrovir.csv")
data_raw<-read.csv(file="output_retrovir_div2.csv")
...
write.csv(sumstats,file="sumstats_mean_retrovir2.csv",row.names = FALSE)
write.csv(sumstats_median,file="sumstats_median_retrovir2.csv",row.names = FALSE)
