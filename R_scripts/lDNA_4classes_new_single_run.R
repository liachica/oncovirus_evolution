...
numGclasses=as.integer(4);     #number of classes for G to avoid rapid emergence of cancer "by chance"
...
write.csv(gdata, file = "single_run_lDNA_3_cleared.csv",row.names = F,quote=F)
